 ...
 * @param {Array} contacts - The processed contact objects.
 * @param {Array} subtasks - The processed subtask objects.
 * @returns {string} The generated HTML for the task details.
*/
function generateTaskDetailsHTML(todoData, contacts, subtasks) {
            ...
            <div class="task-body">
                ...
                <div class="subtasks" id="subtask-container">
                    ...
                    <div class="task-footer">
                        <div class="btn-delete-task" onclick="deleteTask('${todoData.id}')">
                        ...
                        <div class="btn-edit-task" onclick="prepareEditTask('${todoData.id}', '${todoData.title}', '${todoData.description}', '${todoData.contacts}', '${todoData.deadline}', '${todoData.prio}', '${todoData.category}', '${subtasks}', '${todoData.progress}')">
...
/**
 * Processes the task data, prepares contacts and subtasks, and returns the HTML.
 * 
 ...
 */
function processTaskDetails(todoData, id) {
    let contacts = todoData.contacts ? todoData.contacts.map(contact => ({
        name: contact.name,
        color: contact.color,
        id: contact.id,
    ...
    let subtasks = todoData.subtasks ? todoData.subtasks.map(subtask => ({
        title: subtask.title,
        done: subtask.done
    })) : [];

    return generateTaskDetailsHTML(todoData, contacts, subtasks);
}
